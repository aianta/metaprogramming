...
public class Record3TestProcessor extends SourceProcessor {

	public Record3TestProcessor(SourceFile sourceFile) {
		super(sourceFile);
	}
	...
	public void processFile (){
		...
		javaParser.addParseListener(new Record3TestListener());
