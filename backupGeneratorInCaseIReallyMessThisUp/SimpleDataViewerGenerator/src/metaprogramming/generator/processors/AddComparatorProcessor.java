...
public class AddComparatorProcessor extends SourceProcessor {

	public AddComparatorProcessor(SourceFile sourceFile) {
		super(sourceFile);
	}
	...
	public void processFile (){
		...
		javaParser.addParseListener(new AddComparatorListener());
