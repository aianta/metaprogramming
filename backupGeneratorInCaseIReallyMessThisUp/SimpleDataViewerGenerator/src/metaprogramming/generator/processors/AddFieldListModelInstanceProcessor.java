...
public class AddFieldListModelInstanceProcessor extends SourceProcessor {

	public AddFieldListModelInstanceProcessor(SourceFile sourceFile) {
		super(sourceFile);
	}
	...
	public void processFile (){
		...
		javaParser.addParseListener(new AddFieldListModelInstanceListener());
