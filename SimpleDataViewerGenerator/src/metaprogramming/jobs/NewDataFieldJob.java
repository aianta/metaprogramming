...
import metaprogramming.generator.processors.AddStateListenerProcessor;
...
public class NewDataFieldJob extends Job{
	...
	AddStateListenerProcessor addStateListenerProcessor;
	...
	public void run() {
		...
		simpleDataViewerJavaProcessor.getSourceFile()
			.applyMicroservice(addStateListenerProcessor.getSourceFile().getSourceTree(),
					"constructorBody");
		...
		addComparatorProcessor.generate(super.getTargetByName("fieldComparator").getText());
	...
	public void analyzeTargets() {
		...
		addStateListener =
				new SourceFile ("addStateListener", "src/metaprogramming/microservice/addStateListener.java", ".java");
		...
		addStateListenerProcessor = new AddStateListenerProcessor(addStateListener);
		...
		addStateListenerProcessor.processFile();
		...
		super.addSourceFileTargetsToJob(addStateListener);
