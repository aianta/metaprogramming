 ...
 RankListModel rankListModel = new RankListModel ( dataModel ) ;
 DataFieldPanel rankPanel = new DataFieldPanel ( rankListModel , this ) ;
 contentPane . add ( rankPanel ) ;
 record3 . setRank ( "Explorer" ) ;
 record2 . setRank ( "Cheiftan" ) ;
 record1 . setRank ( "Warlord" ) ;
 stateProperty . addPropertyChangeListener ( new SimpleDataViewerListener ( rankPanel ) ) ;
