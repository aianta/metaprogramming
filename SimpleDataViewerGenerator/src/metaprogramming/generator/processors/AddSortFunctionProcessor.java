...
public class AddSortFunctionProcessor extends SourceProcessor {

	public AddSortFunctionProcessor(SourceFile sourceFile) {
		super(sourceFile);
	}
	...
	public void processFile (){
		...
		javaParser.addParseListener(new addSortFunctionListener());
