...
public class AddFieldListModelInstanceListener extends Java8BaseListener {
	
	static Stack<Integer> activeStack = new Stack<Integer>();
	static int nodeId = 0;
	static String filename = "./src/metaprogramming/microservice/json/addFieldListModelInstance.json";
